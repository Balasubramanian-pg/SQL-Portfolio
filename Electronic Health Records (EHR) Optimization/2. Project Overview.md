...
This project is the story of an Electronic Health Records system that passed every technical checkbox and failed every human one. It was a system where the login screen loaded, the buttons clicked, and the servers never crashed. It was, in the most hollow sense of the word, “operational.”
